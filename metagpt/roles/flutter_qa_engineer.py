...
class FlutterQaEngineer(Role):
    def __init__(
        self,
        name="Edward",
        profile="FlutterQaEngineer",
        goal="Write comprehensive and robust tests to ensure codes will work as expected without bugs",
        constraints="The test code you write should conform to code standard, be modular, easy to read and maintain",
