...
WriteFlutterDependencies -> Must be used for changing the dependencies
WriteFlutterDocumentation -> Must be used for Writing Documentation for an existing flutter file
...
3. [ ] Process home.dart including tabs ...
    - File: lib/home.dart
    - Operation: WriteFlutterCode
4. [ ] Process sample_file.dart as specified in ...
    - File: lib/.../domain/sample_file.dart
    - Operation: WriteFlutterDataClassCode
5. [ ] Process sample_repository_file.dart as specified ...
    - File: lib/.../repositories/sample_file.dart
    - Operation: WriteFlutterRepositoryClassCode
6. [ ] Process sample_state_file.dart as specified in ...
    - File: lib/.../states/sample_state.dart
    - Operation: WriteFlutterStateClassCode
7. [ ] Process sample_screen_file.dart
    - File: lib/.../states/sample_state.dart
    - Operation: WriteFlutterScreenClassCode
8. [ ] Process sample_file.dart as specified in ...
    - File: lib/.../sample_file.dart
    - Operation: WriteFlutterDocumentation
...
