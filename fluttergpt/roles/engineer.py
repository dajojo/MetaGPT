...
from metagpt.actions import WriteCode, WriteCodeReview, WriteDesign, WriteTasks ### Refactor for fluttergpt
...
class Engineer(Role):
    ...
    def __init__(
        ...
        constraints: str = "The code should conform to professional standards and be modular and maintainable and well documented",
        n_borg: int = 1,
    ...
    def parse_workspace(cls, system_design_msg: Message) -> str:
        print(f"Parsing Workspace: {system_design_msg.content}")
        if system_design_msg.instruct_content:
            return system_design_msg.instruct_content.dict().get("Python package name").strip().strip("'").strip('"') ### TODO first: What is hapenning here and how can we refactor?
