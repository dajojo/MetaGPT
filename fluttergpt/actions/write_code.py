...
PROMPT_TEMPLATE = """
NOTICE
Role: You are a professional engineer; the main goal is to write nullsafe professional, elegant, modular, easy to read and maintain nullsafe Dart code.
...
class WriteCode(Action):
    ...
    def _save(self, context, filename, code):
        ...
        ws_name = CodeParser.parse_str(block="Dart package name", text=design.content)
