...
PROMPT_TEMPLATE = """
NOTICE
1. Role: You are a QA engineer; the main goal is to design, develop, and execute professional, well-structured, maintainable test cases and scripts for Flutter. Your focus should be on ensuring the product quality of the entire project through systematic testing.
...
-----
## Given the following code, please write appropriate test cases using Flutter's unittest framework to verify the correctness and robustness of this code:
```
{code_to_test}
```
